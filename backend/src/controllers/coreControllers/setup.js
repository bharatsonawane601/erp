...
const setup = async (req, res) => {
  ...
  for (const filePath of settingsFiles) {
    ...
    const settingsToUpdate = {
      dbsquare_app_email: email,
      dbsquare_app_company_email: email,
      dbsquare_app_timezone: timezone,
      dbsquare_app_country: country,
      dbsquare_app_language: language || 'en_us',
    };
  ...
  return res.status(200).json({
    success: true,
    result: {},
    message: 'Successfully DB Square App Setup',
  });
};
